...
# 1. Wczytanie danych
file_path = "raport wad marzec 2026 - katalog_PowerBI.xlsx"
...
# Linia 80% zasady Pareto
ax2.axhline(80, color='gray', linestyle='dashed', alpha=0.7)
ax2.text(len(df_agg)*0.95, 82, 'Zasada 80%', color='gray', va='bottom', ha='right')

# Tytuł i układ
plt.title('Wykres Pareto dla zgłoszeń wad (Oczyszczone Dane)', fontsize=16, fontweight='bold')
plt.tight_layout()

# 6. Zapis wykresu
output_image = "pareto_chart_cleaned.png"
